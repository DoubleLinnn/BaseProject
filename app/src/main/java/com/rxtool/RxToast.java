...
import static com.rxtool.RxTool.getContext;
...
public class RxToast {
    ...
    @ColorInt
    private static final int ERROR_COLOR = Color.parseColor("#808080");

    @ColorInt
    private static final int INFO_COLOR = Color.parseColor("#3F51B5");

    @ColorInt
    private static final int SUCCESS_COLOR = Color.parseColor("#808080");
