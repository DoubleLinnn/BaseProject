...
public abstract class BaseNiceDialog extends DialogFragment {
    private static final String TAG=BaseNiceDialog.class.getName();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            Log.d(TAG,"--------------------savedInstanceState.start----------------------");
    ...
    private void initParams() {
        ...
        if (window != null) {
            ...
            //设置dialog宽度
            if (width == 0) {
                lp.width = DialogUtils.getScreenWidth(getContext()) - 2 * DialogUtils.dp2px(getContext(), margin);
            } else {
                lp.width = DialogUtils.dp2px(getContext(), width);
            }
            //设置dialog高度
            if (height == 0) {
                lp.height = WindowManager.LayoutParams.WRAP_CONTENT;
            } else {
                lp.height = DialogUtils.dp2px(getContext(), height);
            }
